...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; user-select: none; }
    ...
    .card.selected {
        ...
        transform: translateY(-3px); z-index: 8000 !important;
    }
    .card.dragging {
    ...
    el.onmousedown = (e) => {
        ...
        document.onmouseup = (e) => {
            ...
            if (isDragging) {
                ...
                if (selectedInfo && selectedInfo.card.uid === card.uid) clearSelection();
                else { clearSelection(); selectedInfo = { card, srcType, colIdx, cardIdx }; render(); }
            }
        };
    };
}
